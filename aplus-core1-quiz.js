...
const objectiveFiles = [
  "json/aplus-core1/world1/1.1-hatchling.json",
  "json/aplus-core1/world1/1.2-hatchling.json",
  "json/aplus-core1/world1/1.3-hatchling.json",
  "json/aplus-core1/world2/2.1-hatchling.json",
  "json/aplus-core1/world2/2.2-hatchling.json",
  "json/aplus-core1/world2/2.3-hatchling.json",
  "json/aplus-core1/world2/2.4-hatchling.json",
  "json/aplus-core1/world2/2.5-hatchling.json",
  "json/aplus-core1/world2/2.6-hatchling.json",
  "json/aplus-core1/world2/2.7-hatchling.json",
  "json/aplus-core1/world2/2.8-hatchling.json",
  "json/aplus-core1/world3/3.1-hatchling.json",
  "json/aplus-core1/world3/3.2-hatchling.json",
  "json/aplus-core1/world3/3.3-hatchling.json",
  "json/aplus-core1/world3/3.4-hatchling.json",
  "json/aplus-core1/world3/3.5-hatchling.json",
  "json/aplus-core1/world3/3.6-hatchling.json",
  "json/aplus-core1/world3/3.7-hatchling.json",
  "json/aplus-core1/world3/3.8-hatchling.json",
  "json/aplus-core1/world4/4.1-hatchling.json",
  "json/aplus-core1/world4/4.2-hatchling.json",
  "json/aplus-core1/world5/5.1-hatchling.json",
  "json/aplus-core1/world5/5.2-hatchling.json",
  "json/aplus-core1/world5/5.3-hatchling.json",
  "json/aplus-core1/world5/5.4-hatchling.json",
  "json/aplus-core1/world5/5.5-hatchling.json",
  "json/aplus-core1/world5/5.6-hatchling.json"
];
const world6Modes = {
...
const captainModes = {
  "boss-rush-1": { name: "Boss Rush I", file: "json/aplus-core1/captains/boss-rush-1.json" },
  "boss-rush-2": { name: "Boss Rush II", file: "json/aplus-core1/captains/boss-rush-2.json" },
  "weakness-captains": { name: "Weakness Captain Rush", file: "json/aplus-core1/captains/weakness-captains.json" },
  "final-captain-rush": { name: "Final Captain Rush", file: "json/aplus-core1/captains/final-captain-rush.json" }
};
...
function resultDestination() {
  if (exam) return { href: "aplus-core1-final-gauntlet.html", label: "Return to A+ Core 1 Final Boss" };
  if (world === "7") return { href: "aplus-core1-world7.html", label: "Return to World 7" };
  if (world === "6") return { href: "aplus-core1-world6.html", label: "Return to World 6" };
  return { href: `aplus-core1-world${world}-objectives.html`, label: `Return to World ${world}` };
}
...
async function loadQuiz() {
  try {
    ...
    if (exam) {
      questions = await fetchBank(`json/aplus-core1/final-dungeon/practice-exam-${exam}.json`);
      quizInfo.textContent = `🏰 A+ Core 1 • Practice Exam ${exam}`;
      ...
      quizInfo.textContent = `🌋 A+ Core 1 World 7 • ${captainModes[mode].name}`;
      objectiveTitle.textContent = captainModes[mode].name;
      modeDisplay.textContent = captainModes[mode].name;
      returnLink.href = "aplus-core1-world7.html";
      ...
      quizInfo.textContent = `A+ Core 1 World ${world} • Objective ${objective}`;
      objectiveTitle.textContent = `Objective ${objective}`;
      objectiveName.textContent = questions[0]?.blueprint || "";
    } else {
      throw new Error("Unknown or incomplete A+ Core 1 quiz mode.");
    }
...
function showQuestion() {
  ...
  q.choices.forEach((choice, index) => {
    ...
    input.type = "radio"; input.name = "answer"; input.value = index;
...
submitBtn.addEventListener("click", () => {
  ...
  if (selected === null) { feedback.textContent = "Select an answer first."; return; }
  ...
  if (correct) { score++; feedback.textContent = "Correct. " + q.explanation; }
  else feedback.textContent = `Incorrect. Correct answer: ${q.choices[q.answer]}. ${q.explanation}`;
...
function showResults(options = {}) {
  ...
  if (world === "7" && captainModes[mode]) {
    window.HydraCampaignUI?.saveQuizResult({ type: "captain", id: mode, percent, passed, label: captainModes[mode].name, href: `aplus-core1-quiz.html?world=7&mode=${mode}` });
  } else if (exam) {
    window.HydraCampaignUI?.saveQuizResult({ type: "exam", id: exam, percent, passed, label: `Practice Exam ${exam}`, href: `aplus-core1-quiz.html?exam=${exam}` });
  }
